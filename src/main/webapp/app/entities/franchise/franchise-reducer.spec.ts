...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './franchise.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRANCHISE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FRANCHISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FRANCHISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FRANCHISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FRANCHISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FRANCHISE actions', async () => {
      const expectedActions = [
        {
