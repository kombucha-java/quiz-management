...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './player.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLAYER_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLAYER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLAYER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLAYER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLAYER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLAYER actions', async () => {
      const expectedActions = [
        {
