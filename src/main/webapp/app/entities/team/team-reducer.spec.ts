...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './team.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEAM_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEAM actions', async () => {
      const expectedActions = [
        {
