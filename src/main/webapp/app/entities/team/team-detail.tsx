...
export const TeamDetail = (props: RouteComponentProps<{ id: string }>) => {
    ...
    <Row>
      <Col md="8">
        <h2 data-cy="teamDetailsHeading">
          <Translate contentKey="quizManagementApp.team.detail.title">Team</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="teamName">
              <Translate contentKey="quizManagementApp.team.teamName">Team Name</Translate>
            </span>
          </dt>
