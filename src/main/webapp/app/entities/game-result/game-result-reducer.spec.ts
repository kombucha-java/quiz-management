...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GAMERESULT_LIST actions', async () => {
    ...
    it('dispatches FETCH_GAMERESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GAMERESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GAMERESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GAMERESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GAMERESULT actions', async () => {
      const expectedActions = [
        {
