...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './game-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GAMETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_GAMETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GAMETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GAMETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GAMETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GAMETYPE actions', async () => {
      const expectedActions = [
        {
