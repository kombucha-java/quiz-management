...
class RestaurantResourceIT {
    ...
    public static Restaurant createEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().restaurantName(DEFAULT_RESTAURANT_NAME).address(DEFAULT_ADDRESS);
        return restaurant;
    }
    ...
    public static Restaurant createUpdatedEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().restaurantName(UPDATED_RESTAURANT_NAME).address(UPDATED_ADDRESS);
        return restaurant;
    }
    ...
    void putNewRestaurant() throws Exception {
        ...
        updatedRestaurant.restaurantName(UPDATED_RESTAURANT_NAME).address(UPDATED_ADDRESS);
    ...
    void fullUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.restaurantName(UPDATED_RESTAURANT_NAME).address(UPDATED_ADDRESS);
